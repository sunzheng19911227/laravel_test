                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" class="form-horizontal adminex-form" method="POST" action="{{ url('/admin/admins/'.$data['id']) }}">
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="email" placeholder="" id="email" name="email" class="form-control" value="{{ isset($data['email']) ? $data['email']:old('email') }}">
                                        @if ($errors->has('email'))
                                ...
                                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="password" placeholder="" id="password" name="password" class="form-control" value="{{ isset($data['password'])?$data['password']:'' }}">
                                ...
                                <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="password" placeholder="" id="password_confirmation" class="form-control" name="password_confirmation" value="{{ isset($data['password'])?$data['password']:'' }}" >
