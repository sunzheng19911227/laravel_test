                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form role="form" class="form-horizontal adminex-form" method="POST" action="{{ url('/admin/menus/'.$data['id']) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <select class="form-control m-bot15" name="pid">
                                                ...
                                                @if($data['pid'] == $list['id'])
                                                    selected="selected"
                                                @endif >{{ $list['label']}}</option>
                                                    @foreach($list['chindren'] as $l)
                                                    <option value="{{ $l['id'] }}" 
                                                    @if($data['pid'] == $l['id'])
                                                    selected="selected"
                                                    @endif>&nbsp;&nbsp;&nbsp;&nbsp;{{ $l['label']}}</option>
                                                    @endforeach
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" disabled="true" placeholder="" id="name" name="name" class="form-control" value="{{ isset($data['name']) ? $data['name'] :old('name') }}">
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="form-group{{ $errors->has('route') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" placeholder="" id="route" name="route" class="form-control" value="{{ isset($data['route']) ? $data['route'] :old('route') }}">
                                            @if ($errors->has('route'))
                                    ...
                                    <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" placeholder="" id="description" class="form-control" name="description" value="{{ isset($data['description'])?$data['description']:old('description') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('sort_order') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" placeholder="" id="sort_order" class="form-control" name="sort_order" value="{{ isset($data['sort_order'])?$data['sort_order']:old('sort_order') }}">
