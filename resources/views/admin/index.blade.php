...
<section>
    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb">
                <li>
                    <a href="index_alt.html#">Dashboard</a>
                </li>
                            ...
                            <div class="row revenue-states">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <ul class="revenue-nav">
                                        <li><a href="index_alt.html#">weekly</a></li>
                                        <li><a href="index_alt.html#">monthly</a></li>
                                        <li class="active"><a href="index_alt.html#">yearly</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <ul class="goal-progress">
                                <li>
                                    <div class="prog-avatar">
                                        <img src="{{ asset('/assets/admin/images/photos/user1.png') }}" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                            <a href="index_alt.html#">John Doe</a> - Project Lead
                                        </div>
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="{{ asset('/assets/admin/images/photos/user2.png') }}" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                            <a href="index_alt.html#">Cameron Doe</a> - Sales
                                        </div>
                                        <div class="progress progress-xs">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="{{ asset('/assets/admin/images/photos/user3.png') }}" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                            <a href="index_alt.html#">Hoffman Doe</a> - Support
                                        </div>
                                        <div class="progress progress-xs">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="{{ asset('/assets/admin/images/photos/user4.png') }}" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                            <a href="index_alt.html#">Jane Doe</a> - Marketing
                                        </div>
                                        <div class="progress progress-xs">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="{{ asset('/assets/admin/images/photos/user5.png') }}" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                            <a href="index_alt.html#">Hoffman Doe</a> - Support
                            ...
                            <div class="text-center"><a href="index_alt.html#">View all Goals</a></div>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <ul class="to-do-list" id="sortable-todo">
                                <li class="clearfix">
                                    ...
                                    <div class="todo-actionlist pull-right clearfix">
                                        ...
                                        <a href="index_alt.html#" class="todo-remove"><i class="fa fa-times"></i></a>
                                    </div>
                                </li>
                                <li class="clearfix">
                                    <span class="drag-marker">
                ...
                <div class="col-md-4">
                    <div class="panel blue-box twt-info">
                        <div class="panel-body">
                            ...
                            dashboard <a href="index_alt.html#">http://t.co/3laCVziTw4</a>
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <div class="media usr-info">
                                <a href="index_alt.html#" class="pull-left">
