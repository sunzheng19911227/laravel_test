                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" class="form-horizontal adminex-form" method="POST" action="{{ url('/admin/roles/'.$data['id']) }}">
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" placeholder="" id="description" name="description" class="form-control" value="{{ isset($data['description'])?$data['description']:'' }}">
