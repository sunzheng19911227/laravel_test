                        ...
                        <div class="panel-body">
                            <form role="form" class="form-horizontal adminex-form" method="POST" action="{{ url('/product/property') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <label class="radio-inline">
                                            <input type="radio" name="input_box_type" checked="checked" value="1"> 文本
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="input_box_type" value="2"> 复选框
                                        </label>
                                        <label class="radio-inline">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <label class="radio-inline">
                                            <input type="radio" name="input_value_type" checked="checked" value="1"> 文本
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="input_value_type" value="2"> 数字
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="input_value_type" value="3"> 日期
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
