                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" id="form1" class="form-horizontal adminex-form" method="POST" action="{{ url('/product/option_group/'.$data['id']) }}">
...
<script type="text/javascript">
    ...
    $('#submit').click(function(){
        ...
        if(status != status_data) {
            $.ajax({
                type: "post",
                url: "/product/option_group/check_status",
                data: {id : id},
                headers: {
                ...
                success: function (data) {
                    console.log(data);
                    if(data > 0) {
                        if(confirm('这个修改会影响'+data+'个子商品信息，请确认是否修改?')){
                            submit_status = true;
                            $('#form1').submit();
                        }
                    } else {
