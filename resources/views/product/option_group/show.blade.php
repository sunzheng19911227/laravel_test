    ...
    <section>
        ...
        <div class="main-content" >
            ...
            <div class="page-heading">
                ...
                <ul class="breadcrumb">
                    <li>
                        <a href="editable_table.html#">选项组对应属性列表</a>
                    </li>
                    <li>
...
<script>
    ...
    function setDeleteFromAction(id, option_group_id){
        $("#delete-form").attr("action", "/product/option_group/detach/"+id+"/option_group_id/"+option_group_id);
    }
</script>
