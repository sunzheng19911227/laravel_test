                        ...
                        <div class="panel-body">
                            <div class="adv-table editable-table ">
                                <div class="clearfix">
                                    <div class="btn-group">
                                        @can('商品类型-添加')
                                        <a href="{{ url('/product/category/create') }}"><button id="add—admin" class="btn btn-primary">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample" style="margin-top:5px;">
                                    <thead>
                                        <tr>
                                            <th>id</th>
                                            <th>类别名称</th>
                                            <th>Status</th>
                                            @can('商品类型-修改')<th>Edit</th>@endcan
                                            @can('商品类型-删除')<th>Delete</th>@endcan
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr class="">
                                            ...
                                            @can('商品类型-修改')<td><a href="{{ url('/product/category/'.$list['id'].'/edit') }}">Edit</a></td>@endcan
                                            @can('商品类型-删除')<td><a data-toggle="modal" data-target="#modal-delete" href="javascript:;" onclick="setDeleteFromAction({{ $list['id']}} );">Delete</a></td>@endcan
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
...
<script>
    ...
    function setDeleteFromAction(id){
        $("#delete-form").attr("action", "/product/category/"+id);
    }
</script>
